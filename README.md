...
Общий код получения внешней обработки перед использованием [^1]
Пример наполнения данными указав путь к файлу [^2]
Пример наполнения данными указав результат запроса [^3]

[^1]: ОперацияВведеннаяВручнуюВнешняяОбработка()
```1C
...
[^2]: Файл с данными на диске клиента:
```1C
&НаКлиенте
...
[^3]: Выполнить запрос и установить результат как источник данных:
```1C
&НаКлиенте
